...
└── test/
    ...
    ├── ioctl-hardening.Tests.ps1    # Pester: STATUS_DEVICE_BUSY 및 map/unmap/remove 하드닝 회귀 테스트
    ├── audio-loopback-hardening.Tests.ps1 # Pester: render->capture 루프백 신호 경로 검증
...
### audio-loopback-hardening.Tests.ps1
