...
#ifndef _CABLEAUDIO_MINWAVERT_H_
#define _CABLEAUDIO_MINWAVERT_H_
...
#pragma code_seg("PAGE")
        ...
        m_pMiniportPair(MiniportPair)
    {
        ...
        // Cache the wave name so we can look up the ring buffer later.
        // This is critical for dynamic devices where m_pMiniportPair may
        // point to a stack-local ENDPOINT_MINIPAIR that becomes invalid.
        m_WaveName[0] = L'\0';
        if (MiniportPair->WaveName != NULL)
        {
            RtlStringCbCopyW(m_WaveName, sizeof(m_WaveName), MiniportPair->WaveName);
        }
...
#pragma code_seg()
    ...
    friend class        CMiniportTopologyCableAudio;
...
#endif // _CABLEAUDIO_MINWAVERT_H_
