...
CMiniportTopologyCableAudio::CMiniportTopologyCableAudio
(
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyCableAudio::DataRangeIntersection
( 
    _In_  ULONG                 PinId,
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyCableAudio::GetDescription
( 
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyCableAudio::Init
( 
...
--*/
{
    ...
    DPF_ENTER(("[CMiniportTopologyCableAudio::Init]"));
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyCableAudio::PropertyHandlerGeneric
(
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyCableAudio::PropertyHandlerMuxSource
(
    _In_  PPCPROPERTY_REQUEST     PropertyRequest
)
/*++
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyCableAudio::PropertyHandlerDevSpecific(
    _In_  PPCPROPERTY_REQUEST     PropertyRequest
)
/*++
...
#pragma code_seg("PAGE")
VOID
CMiniportTopologyCableAudio::AddEventToEventList
(
...
#pragma code_seg()
VOID
CMiniportTopologyCableAudio::GenerateEventList
(
    _In_opt_    GUID   *Set,
    _In_        ULONG   EventId,
    _In_        BOOL    PinEvent,
...
--*/
{
    DPF_ENTER(("[CMiniportTopologyCableAudio::GenerateEventList]"));
