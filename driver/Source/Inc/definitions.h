...
#ifndef _CABLEAUDIO_DEFINITIONS_H_
#define _CABLEAUDIO_DEFINITIONS_H_
...
#define STATIC_PID_CABLEAUDIO\
    0x836ba6d1, 0x3ff7, 0x4411, 0x8b, 0xcd, 0x46, 0x95, 0x53, 0x45, 0x2d, 0xce
DEFINE_GUIDSTRUCT("836BA6D1-3FF7-4411-8BCD-469553452DCE", PID_CABLEAUDIO);
#define PID_CABLEAUDIO DEFINE_GUIDNAMED(PID_CABLEAUDIO)

// Pool tag used for CableAudio allocations
#define CABLEAUDIO_POOLTAG                       'CBLA'  

// Cable IOCTL control interface GUID
// User-mode opens this interface to send IOCTL commands.
// {A3F2E8B1-7C4D-4F5A-9E6B-1D2C3A4B5E6F}
#define STATIC_GUID_CABLE_CONTROL_INTERFACE \
    0xa3f2e8b1, 0x7c4d, 0x4f5a, 0x9e, 0x6b, 0x1d, 0x2c, 0x3a, 0x4b, 0x5e, 0x6f
DEFINE_GUIDSTRUCT("A3F2E8B1-7C4D-4F5A-9E6B-1D2C3A4B5E6F", GUID_CABLE_CONTROL_INTERFACE);
#define GUID_CABLE_CONTROL_INTERFACE DEFINE_GUIDNAMED(GUID_CABLE_CONTROL_INTERFACE)

// Debug module name
#define STR_MODULENAME              "CABLEAUDIO: "
...
#endif // _CABLEAUDIO_DEFINITIONS_H_
