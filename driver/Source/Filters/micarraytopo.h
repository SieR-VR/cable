...
#ifndef _CABLEAUDIO_MICARRAYTOPO_H_
#define _CABLEAUDIO_MICARRAYTOPO_H_
...
class CMicArrayMiniportTopology :
    public CMiniportTopologyCableAudio,
...
public:
    ...
    (
        ...
        CMiniportTopologyCableAudio(FilterDesc, DeviceMaxChannels),
...
#endif // _CABLEAUDIO_MICARRAYTOPO_H_
