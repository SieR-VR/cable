...
#ifndef _CABLEAUDIO_MICARRAYWAVTABLE_H_
#define _CABLEAUDIO_MICARRAYWAVTABLE_H_
...
static
CABLEAUDIO_PROPERTY_ITEM PropertiesMicArrayWaveFilter[] =
{
    {
        {
            &KSPROPSETID_General,
...
#endif // _CABLEAUDIO_MICARRAYWAVTABLE_H_
