...
#pragma code_seg("PAGE")
NTSTATUS
CableAudioPropertyDispatch
(
    _In_ PPCPROPERTY_REQUEST PropertyRequest
)
/*++
    Handles and dispatches a CABLEAUDIO_PROPERTY_ITEM.

    Use this as the property handler only if the property item is a
    CABLEAUDIO_PROPERTY_ITEM.
--*/
{
    PAGED_CODE();

    CABLEAUDIO_PROPERTY_ITEM* item = (CABLEAUDIO_PROPERTY_ITEM*)PropertyRequest->PropertyItem;
